...
export default function Home() {
  return (
    <main className="bg-gradient-to-bl from-white to-indigo-600 overflow-scroll p-2 lg:p-5 flex-1">
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
        <div className="flex flex-col items-center justify-center max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <br />
              <br />
              Upload your document, and our chatbot will answer questions, summarize content, and answer all your questions. Ideal for everyone, <span className="text-indigo-500">
                PDFNugget
              </span>{" "}
              turns static documents into {" "}
              <span className="font-semibold">
                dynamic conversations
              </span> enhancing productivity 10x fold effotlessly.
            </p>
          </div>
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl className="grid mx-auto max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
